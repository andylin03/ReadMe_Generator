...
//Creating an array(questions) for the user
const questions = [
  {
    type: "input",
    name: "title",
  ...
  },
  {
    ...
    name: "usage",
    message:
      "Please state the languages or technologies associated with this project.",
  },
  {
    type: "input",
    name: "creator",
  ...
  },
  {
    type: "input",
    name: "contributors",
    message: "Please list any other contributors. (Use GitHub usernames)",
    default: "",
  },
  {
    type: "input",
